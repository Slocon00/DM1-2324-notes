...
Correlation analysis is a popular technique for analyzing relationships between pairs of variables. For continuos variables, correlation is defined using \textbf{Pearson's correlation coefficient}.
